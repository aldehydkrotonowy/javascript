...
app.get('*', function (req, res, next) {
  ...
  promise.then(function (data) {
    ...
    // location  - current location requrested by user
    // context   - contain any information about the render
    _react2.default.createElement(
      _reactRouterDom.StaticRouter,
      { location: req.url, context: context },
      _react2.default.createElement(_App2.default, null)
    ));
    res.send('\n    <!DOCTYPE html>\n      <html>\n        <head>\n          <title>SSR adventure</title>\n          <script src="/bundle.js" defer></script>\n          <script>\n            window.__INITIAL_DATA__ = ' + (0, _serializeJavascript2.default)(data) + '\n          </script>\n        </head>\n        <body>\n          <div id="app">' + markup + '</div>\n        </body>\n      </html>\n    ');
  }).catch(next);
});
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        repos.map(function (_ref) {
          ...
          return _react2.default.createElement(
            'li',
            { key: name + html_url, style: { margin: 30 } },
            _react2.default.createElement(
              'ul',
              null,
              _react2.default.createElement(
...
function fetchPopularRepos() {
  ...
  var URI = encodeURI('https://api.github.com/search/repositories?q=stars:>1+language:\n    ' + language + '&sort=stars&order=desc&type=Repositories');

  console.log('uri', URI);
  return (0, _isomorphicFetch2.default)(URI).then(function (data) {
    return data.json();
  }).then(function (repos) {
    return repos.items;
...
exports.default = fetchPopularRepos;
