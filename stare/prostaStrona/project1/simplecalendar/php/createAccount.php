<?php
    ...
    exit;
		...
		$decoded_str = json_decode(file_get_contents('php://input'), true);
		$idIn = '';
		$nameIn = $decoded_str['i_name'];
		$surnameIn = $decoded_str['i_surname'];
		$ageIn = $decoded_str['i_age'];
		$emailIn = $decoded_str['i_email'];
		$loginIn = $decoded_str['i_login'];
		$passwordIn = $decoded_str['i_password'];
