...
* (This is really a very rough approximation of the classical OOP pattern, and not necessarily a "best-practice" for JavaScript programming.) Part 2 covers inheritance.
* -------------------------------------------------------------------------------------
...
* 
* private functions are declared inline inside the object's constructor (or alternatively may be defined via var functionName=function(){...}) and
* may only be called by privileged methods (including the object's constructor).
* 
